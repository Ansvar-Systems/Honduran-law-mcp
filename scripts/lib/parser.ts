/**
 * Honduran Law HTML Parser
 *
 * Parses law HTML from honduras.justia.com into structured provisions.
 *
 * Honduran civil law article patterns:
...
/**
 * Honduran article heading patterns.
 *
 * Standard forms:
...
export function parseHNLawText(text: string, act: ActIndexEntry): ParsedAct {
 ...
 */
export function parseHNLawHtml(html: string, act: ActIndexEntry): ParsedAct {
  let bodyHtml = html;
  ...
  return parseHNLawText(text, act);
}
