...
- **Professional Rules**: Members of the Colegio de Abogados de Honduras must comply with applicable professional conduct rules (código de ética del Colegio de Abogados de Honduras) when using AI tools
...
1. Checking the official source (Poder Judicial — poderjudicial.gob.hn / La Gaceta — diario oficial)
...
This Tool aggregates data from official Honduran legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **La Gaceta (Diario Oficial)** | Authoritative | Statute text, decrees, regulations (primary reference) |
| **Poder Judicial (poderjudicial.gob.hn)** | Authoritative | Court decisions and judicial resolutions |
| **Congreso Nacional** | Authoritative | Legislative records |
...
For professional legal work, **always cross-check with commercial legal databases** and institutional repositories maintained by Honduran universities (UNAH, UNITEC) and the Colegio de Abogados de Honduras, which provide editorial oversight that this Tool **cannot** provide.
...
- Honduran law changes through new statutes (decretos legislativos), executive decrees (decretos ejecutivos), regulatory agreements (acuerdos), and court decisions (sentencias)
...
- Always check official sources for the current legal position (texto vigente)
...
2. **Historical statute versions** -- Limited availability of historical provision wording (texto histórico)
...
5. **Full legislative history** -- Limited coverage of congressional materials (dictámenes, debates legislativos)
...
2. **Official Verification**: Cross-check ALL results with official sources (poderjudicial.gob.hn / La Gaceta)
3. **Bar Resources**: Use Colegio de Abogados de Honduras resources and university repositories for authoritative versions
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Honduran-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Honduran-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (poderjudicial.gob.hn / La Gaceta)
...
- **COMPLY** with Colegio de Abogados de Honduras professional ethics rules regarding AI tool use and client confidentiality
